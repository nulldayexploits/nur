...
.judul-content{ color: #4CAF50; }
.garis-judul-content{ width:70px;border:5px solid #4CAF50; }
.w3-red{ background-color: #4CAF50!important; }
...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>Pencarian Cerpen</b></h3>
  </div>
  <div class="w3-bar-block">
    ...
    <a href="view_cerpen.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Kelola Cerpen</a>
